...
public class MainActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        unknown1_TextView = findViewById(R.id.unknown1_id);
        unknown2_TextView = findViewById(R.id.unknown2_id);
        ...
        engine_rpm_SeekBar = findViewById(R.id.engine_rpm_SeekBar_id);
    }
